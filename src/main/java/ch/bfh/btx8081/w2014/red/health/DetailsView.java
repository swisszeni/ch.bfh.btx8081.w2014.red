...
public class DetailsView extends CustomComponent implements View {
	...
	@AutoGenerated
	private TextField field_mobile, field_email, field_street, field_zip, field_city, field_country;
	...
	public DetailsView() {
		...
		v1.addComponents(field_street, h1, field_country, field_mobile, field_email, field_emergency, field_doctor);
		v1.setSizeUndefined();
		...
		// Combines both the Layouts h1 and v1 into one VerticalLayout viewing them on top of each other
		VerticalLayout v2 = new VerticalLayout();
		v2.addComponents(v1, hbuttons);
		v2.setSizeUndefined();

			
		// add the VerticalLAyout v2 into another VerticalLayout for formatting and sets the Alignment to Middle Center
		...
		button_return.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				((MainUI)UI.getCurrent()).navigator.navigateTo(MainUI.CLIENTVIEW);
			}
		});
