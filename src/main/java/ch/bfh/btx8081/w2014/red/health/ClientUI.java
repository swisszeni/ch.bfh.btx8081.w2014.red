...
public class ClientUI extends UI {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		// Testclient for ClientUI
		final Client testClient = ClientController.getClientForID(13455);
		field_lastname.setValue(testClient.getLastName());
		field_firstname.setValue(testClient.getFirstName());
