	...
	private AbsoluteLayout buildMainLayout() {
		...
		button_details.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				// TODO Auto-generated method stub
				// Address testAddress = new Address("Quellgasse", "2500",
				// "Biel", "Schweiz");
				// Person testPerson = new Person("Mosimann", "Sophie",
				// testAddress, 1900-01-01, "so@gmx.ch", "002493938",
				// "8437894839", "079585858", "www.bild.ch");

				// Client testClient = new Client("Mosimann", "Sophie",
				// testAddress, 1990.01.01, "so@gmx.ch", "002493938",
				// "8437894839", "079585858", "www.bild.ch" false,
				// String privateNr, String mobileNr, String pictureUri,
				// boolean harmless, Person emergencyContact, Doctor doc)

				textField_details.setValue("Kurt");
