...
public class ClientView extends CustomComponent implements View, IMenuListable {
	...
	@AutoGenerated
	private Button button_details, button_return, button_journal, button_edit,
	...
	public void enter(ViewChangeEvent event) {
		...
		embedded_picture.setSource(null);
		
		// Catch if there is no picture specified
		String pictureUri = client.getPictureUri();
		if(pictureUri == null || pictureUri.equals("")) {
			// No Link specified
			pictureUri = "https://raw.githubusercontent.com/swisszeni/ch.bfh.btx8081.w2014.red/master/doc/task11/default.jpg";
		}
		
		ExternalResource src = new ExternalResource(pictureUri);
		embedded_picture.setSource(src);
		setClientDataToReadOnly(true);
	...
	private void showJournalviewForDisplayingClient() {
		((MainUI) UI.getCurrent()).navigator.navigateTo(MainUI.JOURNALVIEW
				+ "/" + currentClientNr);
	}
