...
public class ClientView extends CustomComponent implements View {
	...
	@AutoGenerated
	private Button button_details, button_return, button_edit, button_save,
			button_cancel;
	@AutoGenerated
	...
	public ClientView() {
		...
		v3.addComponents(field_street, h2, field_country, field_mobile,
		...
		// viewing the upper Information next to eaxh other
		HorizontalLayout h1 = new HorizontalLayout();
		h1.addComponents(v1, v2);
		h1.setSizeUndefined();

		// Adds all the HorizontalLayout and the VerticalLayout into another
		// VerticalLayout
	...
	private void addItemPropertyToField(Client c) {
		...
		field_country.setPropertyDataSource(item.getItemProperty("address.country"));
