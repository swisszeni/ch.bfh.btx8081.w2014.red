...
//		label_title.setValue("hier kommt ein Button - zurück");
//		mainLayout.addComponent(label_title, "top:40.0px;left:61.0px;");
		...
		// button_return
				...
				button_return.setWidth("185px");
				button_return.setHeight("-1px");
				mainLayout.addComponent(button_return,
						"top:40.0px;right:290.0px;left:61.0px;");
