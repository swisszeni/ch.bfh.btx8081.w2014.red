...
//	@AutoGenerated
//	private Label label_emergency, label_doctor, label_title, label_lastname, label_firstname, 
//			label_birthdate, label_street, label_zip, label_city, label_country, 
//			label_status, label_mobile, label_email;
	@AutoGenerated
	...
	public ClientView() {
		...
		button_return.setCaption("zurück");
		...
		v1.addComponent(button_return);
		v1.addComponent(embedded_picture);
        v1.setSpacing(true);
