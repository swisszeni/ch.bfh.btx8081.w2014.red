...
public class ClientDataHardcoded implements ClientDataSource {
	...
	private ClientDataHardcoded() {
		...
		clients.add(new Client(1, "Muster", "Hans", null,new Date(1900, 01, 01), "muster@mail.ch", null, null, null, "http://raw.githubusercontent.com/swisszeni/ch.bfh.btx8081.w2014.red/master/doc/task11/f.jpg", true, fry, zoid));
